                    ...
                    <li className={`${styles.vouchers__item} ${styles.vouchers__block}`}>
                        <a className={styles.vouchers__link} href='/'>
                            <div className={styles.vouchers__box}>
                                <img className={styles.vouchers__image} src='assets/icons/app-store.png' />
                            </div>
                        </a>

                        <a className={styles.vouchers__link} href='/'>
                            <div className={styles.vouchers__box}>
                                <img className={styles.vouchers__image} src='assets/icons/google-play.png' />
                            </div>
                        </a>
                ...
                <ul className={styles.vouchers__list}>
                    <li className={styles.vouchers__item}>
                        <div className={styles.vouchers__picture}>
                            <img className={styles.vouchers__img} src='assets/images/vouchers-img.png' alt="voucher__picture" />
                        </div>
                    </li>
                </ul>
            </div>
